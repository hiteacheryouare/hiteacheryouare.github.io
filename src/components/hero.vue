        ...
        <div class="relative px-6 lg:px-8">
          <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
            <div>
              ...
              <div>
                <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Pushing What's Possible <span class="bg-primary text-secondary rounded"> in every aspect of life.</span></h1>
                ...
                <div class="mt-8 flex gap-x-4 sm:justify-center">
                  <a href="/blog" class="inline-block rounded-lg bg-primary px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-indigo-600 hover:bg-indigo-700 hover:ring-indigo-700">
                    Read the blog
