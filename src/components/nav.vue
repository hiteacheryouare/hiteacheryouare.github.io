      ...
      <nav class="flex h-9 items-center justify-between" aria-label="Global">
        <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
          <a href="/" class="-m-1.5 p-1.5">
            ...
            <img class="h-8" src="/FullColorFavi.svg" alt="" />
          </a>
        </div>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                <a v-for="item in navigation" :key="item.name" :href="item.href" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 dark:text-white dark:hover:text-gray-300 hover:bg-gray-400/10">{{ item.name }}</a>
              </div>
              <div class="py-6">
...
import { ref } from 'vue'
  import Bars3Icon from 'bootstrap-icons/icons/list.svg'
  import DialogPanel from 'bootstrap-icons/icons/x-circle.svg'
